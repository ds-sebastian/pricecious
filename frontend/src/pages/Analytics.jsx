...
export default function Analytics() {
    ...
    }, [selectedItemId, selectedTag, mode, timeWindowIds, filterOutliers, stdDevThreshold]);
    ...
    const fetchSingleAnalytics = async (itemId) => {
        ...
        try {
            ...
            setSeriesConfig([{ key: "price", name: "Price", color: "hsl(var(--primary))" }]);
                ...
                <div className="flex-1 space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                {mode === "single" ? "Historical price data for selected item" : "Comparing items by tag"}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {loading ? (
